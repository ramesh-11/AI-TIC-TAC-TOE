...
class AIComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        if player == max_player:
            best = {'position': None, 'score': -math.inf} # each score should maxmize (be larger)
        else:
        ...
        for possible_move in state.available_moves():
            ...
            sim_score['position'] = possible_move # other wise this will get messed up from the recursion part
